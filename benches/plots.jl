...
function plot_benchmark(times_file, r_file, num_samples, OUT_DIR)
  r = CSV.read(OUT_DIR * "/" * r_file, DataFrame; missingstring="-")
  ...
  times = CSV.read(OUT_DIR * "/" * times_file, DataFrame; missingstring="-")
...
function plot_benchmark_comparison(times_1_file, r_1_file, times_2_file, r_2_file, num_samples, OUT_DIR)
  r1 = CSV.read(OUT_DIR * "/" * r_1_file, DataFrame; missingstring="-")
  r2 = CSV.read(OUT_DIR * "/" * r_2_file, DataFrame; missingstring="-")
  r = hcat(r1, r2)
  r = r[1:end-100, :]
  # r_plot = plot(Matrix(r), labels=permutedims(names(r)), legend=:outerbottom, legendcolumns=2, linewidth=2, dpi=300)
  # r_plot = plot(Matrix(r), labels=permutedims(names(r)), legend=:none, legendcolumns=2, linewidth=2, dpi=300, ylimits=(0,12), xlimits=(0,num_samples), yguidefontrotation=-90)
  ...
  times1 = CSV.read(OUT_DIR * "/" * times_1_file, DataFrame; missingstring="-")
  times2 = CSV.read(OUT_DIR * "/" * times_2_file, DataFrame; missingstring="-")
...
function main()
  ...
  # plot_benchmark("times_400.csv", "r_400.csv", 400, OUT_DIR)
  # plot_benchmark_comparison("times_400.csv", "r_400.csv", "realcertify_times_400_2.csv", "realcertify_r_400_2.csv", 400, OUT_DIR)
  plot_benchmark("times_400.csv", "r_400.csv", 400, OUT_DIR)
end
